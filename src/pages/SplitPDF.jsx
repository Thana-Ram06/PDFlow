...
import { Scissors, Upload, Loader2, File } from 'lucide-react';
...
const SplitPDF = () => {
    ...
    const handleSplit = async () => {
        ...
        formData.append('pageIndex', (pageIndex - 1).toString());
        ...
        try {
            ...
            if (response.ok) {
                ...
                a.href = url;
                a.download = `split_page_${pageIndex}.pdf`;
        ...
        <div className="tool-page">
            <div className="primary-action-card">
                ...
                >
                    ...
                    {loading ? 'Splitting...' : 'Extract Page'}
                </button>
            </div>
        </div>
    );
